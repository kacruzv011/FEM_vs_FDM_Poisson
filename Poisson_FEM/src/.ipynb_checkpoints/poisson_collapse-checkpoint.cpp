// --- ARCHIVO: src/poisson_collapse.cpp (MODO DUAL) ---
...
// Usa la cláusula collapse(2) de OpenMP.
...
// --- FUNCIÓN PRINCIPAL DE CÁLCULO (PARALELA CON COLLAPSE) ---
void solve_fem_collapse(int M, int N, const std::vector<Node>& nodes, Eigen::VectorXd& u) {
...
int main(int argc, char *argv[]) {
    ...
    solve_fem_collapse(M, N, nodes, u);
