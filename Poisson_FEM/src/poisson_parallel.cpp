// --- ARCHIVO: src/poisson_parallel.cpp (MODO DUAL) ---
...
// Usa un #pragma omp for simple para paralelizar el ensamblaje.
...
// --- FUNCIÓN PRINCIPAL DE CÁLCULO (PARALELA ESTÁNDAR) ---
void solve_fem_parallel(int M, int N, const std::vector<Node>& nodes, Eigen::VectorXd& u) {
...
int main(int argc, char *argv[]) {
    ...
    solve_fem_parallel(M, N, nodes, u);
