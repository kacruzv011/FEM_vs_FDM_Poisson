// --- ARCHIVO: src/poisson_sincronizacion.cpp (FDM Refactorizado - MODO DUAL) ---
...
// Lógica idéntica a 'sections', se mantiene por consistencia con el proyecto original.
...
void solve_poisson_fdm_sync(int M, int N, std::vector<std::vector<double>> &V, double h, double k) {
...
int main(int argc, char *argv[]) {
    ...
    solve_poisson_fdm_sync(M, N, V, h, k);
