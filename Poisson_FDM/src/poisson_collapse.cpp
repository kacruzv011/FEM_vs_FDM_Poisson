// --- ARCHIVO: src/poisson_collapse.cpp (FDM Refactorizado - MODO DUAL) ---
...
// Paralelizado con OpenMP usando collapse(2), itera hasta convergencia.
...
void solve_poisson_fdm_collapse(int M, int N, std::vector<std::vector<double>> &V, double h, double k) {
...
int main(int argc, char *argv[]) {
    ...
    solve_poisson_fdm_collapse(M, N, V, h, k);
